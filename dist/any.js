"use strict";
let lista = ['Marcus', 'Vinicius', 25]; // esta reclamando pois 25 é um number e declaramos o array como string
lista = ['Marcus', 'Vinicius', '25']; // veja que agora ele aceita pois todos os dados são de fato strings 
let array = ['Marcus', 25, true]; // com o uso do tipo any, podemos atribuir qualquer valor ao dado 'any' valor... 
